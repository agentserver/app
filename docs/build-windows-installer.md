...
当前版本号定义在 `scripts/package-windows.sh` 中的 `VERSION` 变量（如 `VERSION="0.1.6"`）。
...
```bash
# 传输
scp packaging/windows/Output/agentserver-app-0.1.6-setup.exe Administrator@9.0.16.110:C:/Users/Administrator/Desktop/

# 远程静默安装
ssh Administrator@9.0.16.110 'C:\Users\Administrator\Desktop\agentserver-app-0.1.6-setup.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART'
```
